...
def new_company():
    ...
    if form.validate_on_submit():
        ...
        # Trigger webhook
        notify_company_created(company)
...
def add_status_update(brand_id):
    ...
    if form.validate_on_submit():
        ...
        # Trigger webhook
        notify_status_update_created(update)
...
def new_contact(brand_id=None):
    ...
    # Initialize brands.data to an empty list if None
    ...
    if form.validate_on_submit():
        ...
        # Trigger webhook
        notify_contact_created(contact)
